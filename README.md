...
**Public extract:** 8,713 rows · **Live catalog:** 5,621,944 domains
...
- `pw.csv` — public CSV extract (8,713 rows)
- `pw.json` — public JSON extract (8,713 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,713-row public sample | 5,621,944 live domains                           |
...
> Unique Domains. *Available .PW One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
